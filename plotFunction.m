function plotFunction(qList,dqList,endTime,plotUr5On,plotPhi,plotDesiredMotion,method)
if strcmp(method, 'Euler')
tspan=linspace(0,endTime,length(qList));
if (plotUr5On==1) && (plotDesiredMotion ==0)
    ur5_model;
...
if plotUr5On==1 && plotDesiredMotion == 1
    ur5_model;
